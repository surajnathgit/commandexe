...
//     </Card>
  {/* Modal for PricingForm */}
      ...
      //     <PricingForm onClose={handleCloseModal} planName={plan.name} planPrice={isAnnual ? plan.annualPrice : plan.price} />
      //   </DialogContent>
      // </Dialog>
//   );
// };
...
import { Card, Typography, Button, Chip, Box, Dialog, DialogContent } from '@mui/material';
import { useTheme, alpha } from '@mui/material/styles';
import CheckCircleOutlineIcon from '@mui/icons-material/CheckCircleOutline';
